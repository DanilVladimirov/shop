...
class Subscribe(models.Model):
    ...
    is_promo = models.BooleanField(default=False, verbose_name='Promotions')
    is_answer_support = models.BooleanField(default=False, verbose_name='Support response notifications')
    is_create_order = models.BooleanField(default=False, verbose_name='Checkout')
    is_get_digit_file = models.BooleanField(default=False, verbose_name='Receive digital files from order')
    is_authorization = models.BooleanField(default=False, verbose_name='Successful login to your account')
